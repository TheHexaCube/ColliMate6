...
import time
from core.primitives import Cross, Circle, Line
...
class MainWindow: 
    ...
    def start_callback(self):
        ...
        if self.crosshair is None:
            ...
            self.roi_line = Line(
                start_x=100, start_y=cy,
                end_x=w - 100, end_y=cy,
    ...
    def on_roi_data(self, results):
        ...
        for roi_name, data in results.items():
            print(f"{roi_name}: mean={data['mean']:.4f}, peak@{data['peak_position']}, peak_val={data['peak_value']:.4f}")
